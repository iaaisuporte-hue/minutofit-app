    ...
    <div className="page-container">
      <div className="dash-hero" style={{ marginBottom: "var(--space-6)" }}>
        <div>
          ...
          <p className="dash-hero-meta">Visibilidade honesta dos pagamentos — sem DRE, sem conciliação, sem comissões. A mensalidade é cobrada pela sua academia, fora da plataforma — a S2Core não processa esse pagamento.</p>
        </div>
      </div>
